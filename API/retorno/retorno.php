...
define('GUSER', 'michael.reis@orit.com.br');
define('GPWD', 'reis*2020');   
...
$mail->Host = 'smtp.orit.com.br'; /* SMTP utilizado*/
...
if (smtpmailer($txtEmail, 'michael.reis@orit.com.br', $txtNome, $txtAssunto, $corpoMensagem)) {
echo "sucesso";
}
